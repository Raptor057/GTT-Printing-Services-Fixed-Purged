...
namespace Gtt.Labels.UI.WebService.Labels.IndividualLabels
{
    public partial class WalkBehind : XtraReport
    {
        ...
        public WalkBehind(long transmissionID, string revision, string serialNo, int julianDay, int year, string externalReference, string station, string ratio, string lineCode)
        {
