...
{
    public partial class WalkBehind2 : XtraReport
    {
        ...
        public WalkBehind2(long transmissionID, string revision, string serialNo, int julianDay, int year, string externalReference)
        {
